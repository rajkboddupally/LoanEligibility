 ...
 */
public class LoanInEligibleConditionSix extends LoanInEligibilityCondition implements LoanInEligibility {

    public LoanInEligibleConditionSix(int priority, String ruleName) {
    ...
    public boolean runIneligibleCondition(Object payLoad, String stringOne, String stringTwo) {
        ...
        System.out.println("*** LoanInEligibleConditionSix running ***");
